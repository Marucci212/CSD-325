...
def createNewForest():
    ...
    # Calculate lake dimensions and position
    lake_width = 10
    lake_height = 4
    lake_x = (WIDTH - lake_width) // 2
    lake_y = (HEIGHT - lake_height) // 2
    
    for x in range(WIDTH):
        for y in range(HEIGHT):
            # Check if current position is within lake boundaries
